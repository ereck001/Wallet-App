...
import { Convert, ExportCurve, MoneySend, AddCircle } from 'iconsax-react-native'
...
export default () => <View style={styles.container}>
    ...
    <View style={styles.lastTransactionSection}>
        ...
        <View style={styles.Trlist}>
            <TransactionItem 
                img={mockedTrData.image}
                title={mockedTrData.title}
                desc={mockedTrData.description}
                val={mockedTrData.value}
            />
        </View>
    </View>
</View>
